...
alias yt-dlp-mp4='yt-dlp -f "bestvideo[vcodec^=avc1]+bestaudio[ext=m4a]/best[vcodec^=avc1]/best"'
alias yt-dlp-mp4-720p='yt-dlp -f "bestvideo[vcodec^=avc1][height<=720]+bestaudio[ext=m4a]/best[vcodec^=avc1][height<=720]/best[height<=720]"'
alias yt-dlp-mp4-480p='yt-dlp -f "bestvideo[vcodec^=avc1][height<=480]+bestaudio[ext=m4a]/best[vcodec^=avc1][height<=480]/best[height<=480]"'
...
alias ipython-lam='conda run -n lam --live-stream ipython --profile=lam'
