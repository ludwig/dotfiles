--
-- xmonad config file for xmonad-0.9
...
myMouseBindings (XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- you may also bind events to the mouse scroll wheel (button 4 and button 5)
    ]
...
--
-- To match on the WM_NAME, you can use the 'title' in the same way that
...
-- fields in the default config. Any you don't override, will use
-- the defaults defined in xmonad/XMonad/Config.hs
--
